################################################################################
# Script to run inference on a singleimage and visualize the detections against 
# the ground truth. 
#
# This script is hard coded for the regionproposal18 network developed for 
# ISSC2019
#
# @author Simon
# @date 28 Feb 2019
...
# cv2.imshow('src',image_letterbox)
# cv2.waitKey()
