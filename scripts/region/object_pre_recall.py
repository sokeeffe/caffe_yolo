...
for idx, thresh in enumerate(threshold_range):
  ...
  results_df.loc[(results_df['conf']>thresh) & (results_df['gt']>0), tp_string] = 1
  results_df.loc[(results_df['conf']>thresh) & (results_df['gt']<1), fp_string] = 1
  results_df.loc[(results_df['conf']<thresh) & (results_df['gt']>0), fn_string] = 1
  results_df.loc[(results_df['conf']<thresh) & (results_df['gt']<1), tn_string] = 1
