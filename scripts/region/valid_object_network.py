...
out_file = '/home/simon/DeepLearning/caffe/models/Region_Detector/network_perf_full_08Sep2018.csv'
...
for idx, image in enumerate(images):
  ...
  det(idx, im_letterbox, os.path.basename(image_file).split('.')[0], label_file)
  # if idx > 5:
  #   break
