...
python scripts/yolov2/meanAveragePrecision_spl_relative_region.py "results/$ballFile" \
            spl_reg_gt_val.csv region_missed_detects.csv 0 "results/$finalOutFile""_ball_pr.csv"
python scripts/yolov2/meanAveragePrecision_spl_relative_region.py "results/$robotFile" \
            spl_reg_gt_val.csv region_missed_detects.csv 1 "results/$finalOutFile""_robot_pr.csv"
python scripts/yolov2/meanAveragePrecision_spl_relative_region.py "results/$goalpostFile" \
            spl_reg_gt_val.csv region_missed_detects.csv 2 "results/$finalOutFile""_goalpost_pr.csv"
python scripts/yolov2/meanAveragePrecision_spl_relative_region.py "results/$penspotFile" \
