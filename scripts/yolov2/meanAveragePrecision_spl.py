...
gt_df['x1'] = (gt_df['x'] - gt_df['w']/2)*640
gt_df.loc[gt_df['x1']<0, 'x1'] = 0
gt_df['y1'] = (gt_df['y'] - gt_df['h']/2)*480
gt_df.loc[gt_df['y1']<0, 'y1'] = 0
gt_df['x2'] = (gt_df['x'] + gt_df['w']/2)*640
gt_df.loc[gt_df['x2']>=640, 'x2'] = 639
gt_df['y2'] = (gt_df['y'] + gt_df['h']/2)*480
gt_df.loc[gt_df['y2']>=480, 'y2'] = 439
gt_df['detected'] = 0
gt_df['Prob'] = 0
